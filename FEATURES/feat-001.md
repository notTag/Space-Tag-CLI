...
- Active space: flash the space tag 5 times, then stop.
...
## Done When
- [ ] Flash activates exactly 5 times on the active space tag, then stops.
- [ ] Non-active space tag stays in the changed color (flash color, no flashing) until the space becomes active.
